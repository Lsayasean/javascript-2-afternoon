...
backPack.color = 'Black'; // maybe wrong
...
function makeCard(cardNumber, expirationDate, securityCode, securityCode){
  var obj = {};
  obj.cardNumber;
  obj.expirationDate;
  obj.securityCode;
